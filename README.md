...
Here's an overview of the supported EML documents, and how these are used in [Abacus](https://github.com/kiesraad/abacus/) and [e-KS](https://github.com/kiesraad/e-ks):
...
defines the regions for all elections in the Netherlands. The relevant regions
for a particular election are included in the election definition.
