...
use crate::{
    EMLError, EMLErrorKind, EMLVersion,
...
impl FromStr for MasterElectionTree {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Self::parse_eml_fragment(s, EMLParsingMode::Strict, EMLVersion::default()).ok()
    }
}
...
impl TryFrom<&str> for MasterElectionTree {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        use crate::io::EMLRead as _;
        Self::parse_eml_fragment(value, EMLParsingMode::Strict, EMLVersion::default()).ok()
    }
}
...
mod tests {
    ...
    fn test_committee_parsing() {
        ...
        let committee =
            MetCommittee::parse_eml_fragment(&xml, EMLParsingMode::Strict, EMLVersion::default())
                .unwrap();
        ...
        let xml_output = test_write_eml_element(&committee, &[], EMLVersion::default()).unwrap();
    ...
    fn test_council_parsing() {
        ...
        let council =
            Council::parse_eml_fragment(&xml, EMLParsingMode::Strict, EMLVersion::default())
                .unwrap();
        ...
        let xml_output = test_write_eml_element(&council, &[], EMLVersion::default()).unwrap();
        assert_eq!(xml_output, xml);
    }
    ...
    fn test_region_parsing() {
        ...
        let region =
            MetRegion::parse_eml_fragment(&xml, EMLParsingMode::Strict, EMLVersion::default())
                .unwrap();
        ...
        let xml_output = test_write_eml_element(&region, &[], EMLVersion::default()).unwrap();
    ...
    fn test_master_election_tree_rejects_non_state_root() {
        ...
        let error = MasterElectionTree::parse_eml_fragment(
            &xml,
